...
public class FFTUtils {
  ...
  /**
   * Find only the real component of the Complex[]. Truncates according to length
   *
   * @param data   Complex[]
   * @param length truncation size
   ...
   *
   * @param data accepts non-padded data
