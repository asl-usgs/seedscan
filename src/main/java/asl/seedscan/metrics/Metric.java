...
public abstract class Metric {
  ...
  /**
   * Gets the version. This function appears to not be used.
   *
   * @return the version
   */
  ...
  /**
   * Return an extended summary of what the metric does. Usually this should match the javadoc
   * header for the class. Things like citations, etc. should ideally be included.
   *
  ...
  /**
   * Dynamic argument managment Adds the argument to the arguments hashtable with empty string as
   * value.
   *
  ...
  /**
   * get(key) returns value if key is found in Hashtable arguments returns null if key is found but
   * value is not set (value="") throws NoSuchFieldException if key is not found.
   *
